...
### Role in the Multi-Agent Ecosystem

> **Orchestrator** — Bifrost receives a user request, classifies intent, delegates to specialised tool/agent workers, and assembles the final response.
>
